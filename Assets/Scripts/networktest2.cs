...
public class networktest2 : NetworkBehaviour
{
	...
	//took base value from playerstart pos game object
	...
	public void ReplacePlayer(NetworkConnection conn)
	{
		...
		NetworkServer.ReplacePlayerForConnection(conn, Instantiate(playerPrefabToSpawn, playerSpawnPosition, Quaternion.Euler(0, 0, 0)));
